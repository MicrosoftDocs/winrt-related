---
description: Contains any errors from processing the WLANProfile elements from the last provisioning attempt (ResultsSchema_v2 schema).
Search.Product: eADQiWindows 10XVcnh
title: WLANProfiles (ResultsSchema_v2 schema)
