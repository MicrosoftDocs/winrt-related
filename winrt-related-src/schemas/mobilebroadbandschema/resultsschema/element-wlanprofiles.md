---
description: Contains any errors from processing the WLANProfile elements from the last provisioning attempt (ResultsSchema schema).
Search.Product: eADQiWindows 10XVcnh
title: WLANProfiles (ResultsSchema schema)
...
# WLANProfiles (ResultsSchema schema)
