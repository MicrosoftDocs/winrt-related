---
description: Contains any errors from processing the MBNProfiles element from the last provisioning attempt (ResultsSchema schema).
Search.Product: eADQiWindows 10XVcnh
title: MBNProfiles (ResultsSchema schema)
...
# MBNProfiles (ResultsSchema schema)
