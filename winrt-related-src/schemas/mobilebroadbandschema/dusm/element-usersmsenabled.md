---
description: Indicates whether the subscriber's service includes user-to-user SMS which must be delivered in near real-time (in Cost/CarrierPolicy).
Search.Product: eADQiWindows 10XVcnh
title: UserSMSEnabled (DUSM schema)
