---
description: The default tile that represents the app on the Start screen (feature extensions schema for Windows 8.1).
Search.Product: eADQiWindows 10XVcnh
title: DefaultTile (feature extensions schema for Windows 8.1)
