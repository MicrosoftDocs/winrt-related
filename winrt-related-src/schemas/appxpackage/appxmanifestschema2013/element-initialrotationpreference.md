---
description: Describes the orientations in which the app would prefer to be shown for the best user experience (feature extensions schema for Windows 8.1).
Search.Product: eADQiWindows 10XVcnh
title: InitialRotationPreference (Windows 8.1 feature extensions schema)
