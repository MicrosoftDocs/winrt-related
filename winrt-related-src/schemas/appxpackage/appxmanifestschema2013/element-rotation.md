...
MS-HAID: AppxManifestSchema2013.element\_Rotation
MSHAttr:
...
To specify more than one preferred orientation, include multiple [**Rotation**](https://msdn.microsoft.com/library/windows/apps/dn423300) elements in your [**InitialRotationPreference**](https://msdn.microsoft.com/library/windows/apps/dn423279) element.
