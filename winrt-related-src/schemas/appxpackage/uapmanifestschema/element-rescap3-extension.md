...
no-loc: [Package, Applications, Application, Extensions, rescap3:Extension]
---
...
```xml
<rescap3:Extension
  Category = 'A required string that can have one of the following values: "windows.lockScreenComponent", or "windows.desktopAppMigration".'
...
|-|-|-|-|-|
| **Category** | The type of extension. | A string that must be one of the following values: *windows.lockScreenComponent*, *windows.desktopAppMigration*. | Yes |  |
