...
|-|-|-|-|-|
| **Category** | The type of package extensibility point. | A string that can have one of the following values: *windows.sharedFonts* or *windows.enterpriseDataProtection*. | Yes |  |
