...
|-----------|-------------|-----------|----------|
| Category | The category of the extension. | One of the following:<ul><li>windows.sharedFonts</li><li>windows.enterpriseDataProtection</li></ul> | Yes |
...
| [uap7:EnterpriseDataProtection](element-uap7-enterprisedataprotection.md) | When declared in an app, this ensures that all files it creates and clipboard/dragged items are encrypted. | 
...
|   | Value |
|--|--|
| **Namespace** | `http://schemas.microsoft.com/appx/manifest/uap/windows10/7`<br/><br/>`http://schemas.microsoft.com/appx/manifest/uap/windows10/10` (for the **uap10** attributes) |
