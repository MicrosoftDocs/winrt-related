...
```xml
<desktop10:Extension
  Category = 'A required string that can have one of the following values: "windows.folder", "windows.dataShortcuts", or "windows.customDesktopEventLog".'
...
|-|-|-|-|-|
| **Category** |  The category of the extension.  | A string that must be one of the following values: *windows.folder*, *windows.dataShortcuts*, *windows.customDesktopEventLog*. | Yes |  |
