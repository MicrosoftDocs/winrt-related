...
no-loc: [Package, Applications, Application, Extensions, cloudFiles:Extension]
---
...
```xml
<cloudFiles:Extension
  Category = 'A required string with the value "windows.cloudFiles".'
...
|-|-|-|-|-|
| **Category** | The type of extension. | A string that must be one of the following values: *windows.cloudFiles*. | Yes |  |
