...
ms.topic: reference
ms.date: 04/05/2017
no-loc: [Package, Applications, Application, uap3:Extension]
---
...
|-|-|-|-|-|
| **Category** | The type of package extensibility point. | A string that can have one of the following values: *windows.appointmentDataProvider*, *windows.emailDataProvider*, *windows.contactDataProvider*, *windows.appUriHandler*, *windows.appExtensionHost*, *windows.appExtension*, *windows.protocol*, *windows.fileTypeAssociation*, *windows.appExecutionAlias*. | Yes |  |
