...
no-loc: [Package, Applications, Application, Extensions, com4:Extension, com4:ComServer, com4:InProcessHandler, com4:Class]
---
...
| **DisplayName** | The class display name. | An optional string between 1 and 256 characters in length. This string is localizable. | No |  |
