...
```xml
<desktop2:Extension
  Category = 'A required string that can have one of the following values: "windows.appPrinter", "windows.searchFilterHandler", "windows.searchPropertyHandler", "windows.mailProvider", "windows.firewallRules", or "windows.desktopEventLogging".'
