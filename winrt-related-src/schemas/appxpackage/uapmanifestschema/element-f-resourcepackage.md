...
ms.topic: reference
ms.date: 04/05/2017
no-loc: [Package, Properties, ResourcePackage]
---
...
- A resource package can't define the [Dependencies](element-f-dependencies.md), [Capabilities](element-f-capabilities.md), [Applications](element-f-applications.md), [Extensions (type: CT_PackageExtensions)](element-extensions.md), and [Framework](element-f-framework.md) elements.
