...
```xml
<rescap4:Extension
  Category = 'A required string that can have one of the following values: "windows.primaryInteropAssemblies", or "windows.classicAppCompatKeys".'
...
|-|-|-|-|-|
| **Category** | The type of extension. | A string that must be one of the following values: *windows.primaryInteropAssemblies*, *windows.classicAppCompatKeys*. | Yes |  |
