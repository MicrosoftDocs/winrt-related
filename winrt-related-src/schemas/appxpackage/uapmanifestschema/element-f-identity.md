...
|-|-|-|-|-|
| **Name** | Describes the contents of the package. The *Name* attribute is case-sensitive. Use the [DisplayName](element-f-displayname.md) attribute to display a package name to users. | A string with a value between 3 and 50 characters in length that consists of alpha-numeric, period, and dash characters. Additionally, it cannot be any of the folllowing string values: *CON*, *PRN*, *AUX*, *NUL*, *COM1*, *COM2*, *COM3*, *COM4*, *COM5*, *COM6*, *COM7*, *COM8*, *COM9*, *LPT1*, *LPT2*, *LPT3*, *LPT4*, *LPT5*, *LPT6*, *LPT7*, *LPT8*, or *LPT9*. | Yes |  |
