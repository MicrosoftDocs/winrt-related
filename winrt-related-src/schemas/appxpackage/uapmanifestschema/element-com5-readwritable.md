...
no-loc: [Package, Applications, Application, Extensions, com5:Extension, com5:ComServer, com5:InProcessServer, com5:Class, com5:Conversion, com5:ReadWritable, com5:InProcessHandler]
---
...
|-|-|
| [com5:Format](element-com5-format.md) | Specifies the file format an application can read from or write to. |
