...
```xml
<rescap2:Extension
  Category = 'A required string with the value "windows.userDataAccountsProvider".'
...
|-|-|-|-|-|
| **Category** | The type of app extensibility point. | A string that must be one of the following values: *windows.userDataAccountsProvider*. | Yes |  |
