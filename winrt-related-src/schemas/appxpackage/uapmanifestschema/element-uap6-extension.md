...
no-loc: [Package, Applications, Application, Extensions, uap6:Extension]
---
...
```xml
<uap6:Extension
  Category = 'A required string that can have one of the following values: "windows.barcodeScannerProvider", "windows.localExperiencePack", "windows.barcodeScannerPreviewProvider", or "windows.loaderSearchPathOverride".'
...
|-|-|-|-|-|
| **Category** | The type of package extensibility point. | A string that must be one of the following values: *windows.barcodeScannerProvider*, *windows.localExperiencePack*, *windows.barcodeScannerPreviewProvider* (in Application); *windows.loaderSearchPathOverride* (in Package). | Yes |  |
...
| [uap6:LoaderSearchPathOverride](element-uap6-loadersearchpathoverride.md) | Used for overriding the path used to load search results. |
