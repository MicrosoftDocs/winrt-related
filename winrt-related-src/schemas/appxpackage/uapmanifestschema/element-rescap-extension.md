---
title: rescap:Extension
description: Declares an extensibility point for the app (rescap:Extension).
ms.date: 06/05/2026
ms.topic: reference
keywords: windows 10, uwp, schema, manifest, extension
no-loc: [Package, Applications, Application, Extensions, rescap:Extension]
---
...
```xml
<rescap:Extension
  Category = 'A required string with the value "windows.settingsApp".'
...
|-|-|-|-|-|
| **Category** | The type of package extensibility point. | A string that must be one of the following values: *windows.settingsApp*. | Yes |  |
