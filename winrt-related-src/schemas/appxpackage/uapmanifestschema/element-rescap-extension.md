...
```xml
<rescap:Extension
  Category = 'A string that can have one of the following values: "windows.settingsApp".'
  ...
  <!-- Child elements -->
  rescap:PrimaryInteropAssemblies?
  rescap:ClassicAppCompatKeys? 
...
|-|-|-|-|-|
| **Category** | The type of package extensibility point. | Can be one of the following values: *windows.settingsApp*. | Yes |  |
...
|-|-|
| [SettingsApp](element-rescap-settingsapp.md) | Registers deep link and search information for apps that appear in the Windows Settings app. |
