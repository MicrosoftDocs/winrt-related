...
no-loc: [Package, Applications, Application, Extensions, desktop7:Extension]
---
...
| [desktop7:ApplicationRegistration](element-desktop7-applicationregistration.md) | Registers an application in the registry, replacing the need to register the application in the system PATH variable. |
...
|-|-|
| [Extensions (in Package)](element-f-package-extensions.md) | Defines one or more extensibility points for the package. |
