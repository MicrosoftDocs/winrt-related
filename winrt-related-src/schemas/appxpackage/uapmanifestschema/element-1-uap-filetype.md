...
ms.topic: reference
ms.date: 04/05/2017
no-loc: [Package, Applications, Application, Extensions, uap:Extension, uap:ShareTarget, uap:FileOpenPicker, uap:FileType, uap:FileSavePicker, uap:FileType, uap:SupportedFileTypes, uap:FileType]
---
