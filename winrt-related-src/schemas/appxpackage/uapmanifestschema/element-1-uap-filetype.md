---
Description: uap:FileType (in uap:ShareTarget/uap:SupportedFileTypes) (Windows 10)
MS-HAID: UapManifestSchema.element\_1\_uap\_FileType
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/apps
Search.Product: eADQiWindows 10XVcnh
title: uap:FileType (in uap:ShareTarget/uap:SupportedFileTypes) (Windows 10)
