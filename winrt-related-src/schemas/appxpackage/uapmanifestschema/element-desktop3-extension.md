...
no-loc: [Package, Applications, Application, Extensions, desktop3:Extension]
---
...
```xml
<desktop3:Extension
  Category = 'A required string that can have one of the following values: "windows.cloudFiles", or "windows.autoPlayHandler".'
...
|-|-|-|-|-|
| **Category** | The category of the extension. | A string that must be one of the following values: *windows.cloudFiles*, *windows.autoPlayHandler*. | Yes |  |
