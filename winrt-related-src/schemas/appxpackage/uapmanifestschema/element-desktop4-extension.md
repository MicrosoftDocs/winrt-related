...
no-loc: [Package, Applications, Application, Extensions, desktop4:Extension]
---
...
```xml
<desktop4:Extension
  Category = 'A required string with the value "windows.fileExplorerContextMenus".'
...
|-|-|-|-|-|
| **Category** | The category of the extension. | A string that must be one of the following values: *windows.fileExplorerContextMenus*. | Yes |  |
