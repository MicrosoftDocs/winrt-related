...
no-loc: [Package, Applications, Application, Extensions, desktop6:Extension, desktop6:Service, desktop6:TriggerEvents, desktop6:TriggerCustom, desktop6:KeywordAllData]
---
...
```xml
<desktop6:KeywordAllData
  Value = 'A required unsigned 64-bit integer value.' />
```
...
|-|-|-|-|-|
| **Value** | The data value for the trigger event. | A unsigned 64-bit integer value. | Yes |  |
