...
MS-HAID: UapManifestSchema.element\_3\_uap\_SupportedFileTypes
MSHAttr:
...
<tbody>
<tr class="odd">
<td>[uap:FileType (type: ST_FileType)](element-3-uap-filetype.md)</td>
...
<tr class="even">
<td>[uap:SupportsAnyFileType](element-2-uap-supportsanyfiletype.md)</td>
