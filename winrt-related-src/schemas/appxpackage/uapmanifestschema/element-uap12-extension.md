...
no-loc: [Package, Applications, Application, Extensions, uap12:Extension]
---
...
|-|-|-|-|-|
| **Category** | The type of extension. | A string that must be one of the following values: *windows.printSupportSettingsUI*, *windows.printSupportExtension*, *windows.printSupportWorkflow*, *windows.printSupportJobUI*. | Yes |  |
...
| Item | Value |
|--|--|
| **Namespace** | `http://schemas.microsoft.com/appx/manifest/uap/windows10/12` |
