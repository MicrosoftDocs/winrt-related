---
title: uap12:Extension (in Application/Extensions)
...
# uap12:Extension (in Application/Extensions)
...
## Syntax
```syntax
<uap12:Extension Category       = "windows.printSupportSettingsUI", "windows.printSupportExtension", "windows.printSupportWorkflow", "windows.printSupportJobUI"
...
|---------------|-------------|
| [PrintSupportSettingsUI](element-uap12-printsupportsettingsui.md) |  |
| [PrintSupportExtension](element-uap12-printsupportextension.md) |  |
| [PrintSupportWorkflow](element-uap12-printsupportworkflow.md) |  |
| [PrintSupportJobUI](element-uap12-printsupportjobui.md) |  |

## Parent Element

| Parent Element | Description |
|---------------|-------------|
| [Extensions (in Applications/Extensions)](element-1-extensions.md) | Declares an extensibility point for the package |
