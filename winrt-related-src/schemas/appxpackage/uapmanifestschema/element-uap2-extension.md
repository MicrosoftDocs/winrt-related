---
title: uap2:Extension
description: Declares an extensibility point for the app (uap2:Extension).
ms.date: 06/05/2026
ms.topic: reference
keywords: windows 10, uwp, schema, package, manifest
no-loc: [Package, Applications, Application, Extensions, uap2:Extension]
---
...
```xml
<uap2:Extension
  Category = 'A required string with the value "windows.webAccountProvider".'
...
|-|-|-|-|-|
| **Category** | The type of extension. | A string that must be one of the following values: *windows.webAccountProvider*. | Yes |  |
