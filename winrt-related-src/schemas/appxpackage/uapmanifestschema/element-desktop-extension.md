...
| **uap10:HostId** | Specifies the ID of the host runtime for the extension. | An optional alphanumeric string with a value between 1 and 255 characters in length. Must begin with an alphabetic character. | No |  |
...
|-|-|
| [Extensions](element-f-application-extensions.md) | Declares an extensibility point for the package. |
