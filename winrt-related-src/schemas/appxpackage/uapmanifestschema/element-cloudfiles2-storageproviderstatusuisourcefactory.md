...
|-|-|-|-|-|
| **Clsid** | The class ID of the app that implements the StorageProviderStatusUI, used for the storage provider status UI flyout for placeholder files. | A GUID in the form xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx. | Yes |  |
