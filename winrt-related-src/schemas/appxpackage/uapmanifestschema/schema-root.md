...
| [printSupport2:PrintSupportVirtualPrinter](element-printsupport2-extension.md) | Declares an extensibility point for a Print Support App, adding support for virtual printers. |
