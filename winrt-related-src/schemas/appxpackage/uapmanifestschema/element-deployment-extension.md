...
no-loc: [Package, Applications, Application, Extensions, deployment:Extension]
---
...
```xml
<deployment:Extension
  Category = 'A required string with the value "windows.deploymentExtensionHandler".'
...
|-|-|-|-|-|
| **Category** |  The category of the extension.  | A string that must be one of the following values: *windows.deploymentExtensionHandler*. | Yes |  |
