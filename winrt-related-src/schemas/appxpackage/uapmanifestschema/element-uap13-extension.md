...
no-loc: [Package, Applications, Application, Extensions, uap13:Extension]
---
...
```xml
<uap13:Extension
  Category = 'A required string with the value "windows.phoneCallActivation".'
...
|-|-|-|-|-|
| **Category** | The type of extension. | A string that must be one of the following values: *windows.phoneCallActivation*. | Yes |  |
