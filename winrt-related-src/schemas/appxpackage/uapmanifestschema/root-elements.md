...
-   [**Package**](element-f-package.md)
    -   [**Identity**](element-f-identity.md)
    -   [**mp:PhoneIdentity**](element-mp-phoneidentity.md)
    -   [**Properties**](element-f-properties.md)
        -   [**Framework**](element-f-framework.md)
        -   [**DisplayName**](element-f-displayname.md)
        -   [**PublisherDisplayName**](element-f-publisherdisplayname.md)
        -   [**Description**](element-f-description.md)
        -   [**Logo**](element-f-logo.md)
        -   [**ResourcePackage**](element-f-resourcepackage.md)
    ...
    -   [**Resources**](element-f-resources.md)
        -   [**Resource**](element-f-resource.md)
    -   [**Dependencies**](element-f-dependencies.md)
        -   [**TargetDeviceFamily**](element-f-targetdevicefamily.md)
        -   [**PackageDependency**](element-f-packagedependency.md)
        -   [**uap3:MainPackageDependency**](element-uap3-mainpackagedependency.md)
    ...
    -   [**Capabilities**](element-f-capabilities.md)
        -   [**Capability**](element-f-capability.md)
        -   [**uap:Capability**](element-uap-capability.md)
        -   [**uap2:Capability**](element-uap2-capability.md)
        -   [**uap3:Capability**](element-uap3-capability.md)
        ...
        -   [**DeviceCapability**](element-f-devicecapability.md)
            -   [**Device**](element-f-device.md)
                -   [**Function**](element-f-function.md)
    -   [**Extensions**](element-extensions.md)
        ...
        -   [**Extension**](element-f-extension.md)
            ...
            -   [**InProcessServer**](element-f-inprocessserver.md)
                -   [**Path**](element-f-path.md)
                -   [**ActivatableClass**](element-f-activatableclass.md)
                    -   [**ActivatableClassAttribute**](element-f-activatableclassattribute.md)
            -   [**OutOfProcessServer**](element-f-outofprocessserver.md)
                -   [**Path**](element-f-outofprocessserver-path.md)
                -   [**Arguments**](element-f-arguments.md)
                -   [**Instancing**](element-f-instancing.md)
            ...
            -   [**ProxyStub**](element-f-proxystub.md)
                ...
                -   [**Interface**](element-f-interface.md)
            -   [**Certificates**](element-f-certificates.md)
                -   [**Certificate**](element-f-certificate.md)
                -   [**TrustFlags**](element-f-trustflags.md)
                -   [**SelectionCriteria**](element-f-selectioncriteria.md)
            -   [**PublisherCacheFolders**](element-f-publishercachefolders.md)
                -   [**Folder**](element-f-folder.md)
    ...
    -   [**Applications**](element-f-applications.md)
        -   [**Application**](element-f-application.md)
            ...
            -   [**uap3:VisualElements**](element-uap3-visualelements.md) 
            ...
            -   [**Extensions**](element-f-application-extensions.md)
                ...
                -   [**cloudFiles:Extension**](element-cloudfiles-extension.md)
                    -   [**cloudFiles:CloudFiles**](element-cloudfiles-cloudfiles.md)
                        ...
                        - [**cloudFiles:CustomStateHandler**](element-cloudfiles-customstatehandler.md)
                        ...
                        -   [**com:ExeServer**](element-com-exeserver.md)
                            -   [**com:Class**](element-com-exeserver-class.md)
                                -   [**com:ImplementedCategories**](element-com-implementedcategories.md)
                                    -   [**com:ImplementedCategory**](element-com-implementedcategory.md)
                                -   [**com:Conversion**](element-com-conversion.md)
                                    -   [**Readable**](element-com-readable.md)
                                        -   [**Format**](element-com-format.md)
                                    -   [**ReadWritable**](element-com-readwritable.md)
                                        -   [**Format**](element-com-format.md)
                                -   [**com:DataFormats**](element-com-dataformats.md)
                                    -   [**com:DataFormat**](element-com-dataformat.md)
                                -   [**com:MiscStatus**](element-com-miscstatus.md)
                                    -   [**com:Aspect**](element-com-aspect.md)
                                -   [**com:Verbs**](element-com-verbs.md)
                                    -   [**com:Verb**](element-com-verb.md)
                                -   [**com:DefaultIcon**](element-com-defaulticon.md)
                                -   [**com:ToolboxBitmap32**](element-com-toolboxbitmap32.md)
                ...
                -   [**rescap:Extension**](element-rescap-extension.md)
                    -   [**rescap:SettingsApp**](element-rescap-settingsapp.md)
                        -   [**rescap:AppLinks**](element-rescap-applinks.md)
                            -   [**rescap:Link**](element-rescap-link.md)
                        -   [**rescap:SearchTerms**](element-rescap-searchterms.md)
                            -   [**rescap:Term**](element-rescap-term.md)
                -   [**rescap2:Extension**](element-rescap2-extension.md)
                ...
                -   [**uap:Extension**](element-uap-extension.md)
                    -   [**uap:FileTypeAssociation**](element-uap-filetypeassociation.md)
                        ...
                        -   [**uap:SupportedFileTypes**](element-uap-supportedfiletypes.md)
                            -   [**uap:FileType**](element-uap-filetypeassociation-filetype.md)
                    ...
                    -   [**uap:AutoPlayContent**](element-uap-autoplaycontent.md)
                        -   [**uap:LaunchAction**](element-uap-autoplaycontent-launchaction.md)
                    -   [**uap:AutoPlayDevice**](element-uap-autoplaydevice.md)
                        -   [**uap:LaunchAction**](element-uap-autoplaydevice-launchaction.md)
                    -   [**uap:ShareTarget**](element-uap-sharetarget.md)
                        -   [**uap:SupportedFileTypes**](element-uap-sharetarget-supportedfiletypes.md)
                            -   [**uap:FileType**](element-uap-sharetarget-filetype.md)
                    ...
                    -   [**uap:FileSavePicker**](element-uap-filesavepicker.md)
                        -   [**uap:SupportedFileTypes**](element-uap-filesavepicker-supportedfiletypes.md)
                            -   [**uap:FileType**](element-uap-sharetarget-filetype.md)
                            -   [**uap:SupportsAnyFileType**](element-uap-supportsanyfiletype.md)
                    -   [**uap:AppointmentsProvider**](element-uap-appointmentsprovider.md)
                        -   [**uap:AppointmentsProviderLaunchActions**](element-uap-appointmentsproviderlaunchactions.md)
                            -   [**uap:LaunchAction**](element-uap-appointmentsproviderlaunchactions-launchaction.md)
                ...
                -   [**uap3:Extension**](element-uap3-extension.md)
                    ...
                    -   [**uap3:AppointmentDataProvider**](element-uap3-appointmentdataprovider.md)
                    -   [**uap3:EmailDataProvider**](element-uap3-emaildataprovider.md)
                    -   [**uap3:ContactDataProvider**](element-uap3-contactdataprovider.md)
                ...
                -   [**uap10:Extension (child of Package)**](element-uap10-extension.md)
