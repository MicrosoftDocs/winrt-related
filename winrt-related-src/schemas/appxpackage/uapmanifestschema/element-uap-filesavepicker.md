...
|-|-|
| [uap:SupportedFileTypes (type: CT_CharmsSupportedFileTypes)](element-uap-filesavepicker-supportedfiletypes.md) | Defines the file types that the app can share. |
