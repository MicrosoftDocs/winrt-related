...
ms.topic: reference
ms.date: 04/05/2017
no-loc: [Package, Extensions, Extension, OutOfProcessServer, ActivatableClass]
---
...
- **[ActivatableClass (type: CT_InProcessActivatableClass)](element-f-activatableclass.md)**
