...
no-loc: [Package, Applications, Application, Extensions, com4:Extension, com4:ComServer, com4:SurrogateServer, com4:Class]
---
...
|-|-|-|-|-|
| **Path** | The path to the surrogate server DLL. | An optional string between 1 and 256 characters in length that cannot contain these characters: <, >, :, ", &#124;, ?, or *. | No |  |
