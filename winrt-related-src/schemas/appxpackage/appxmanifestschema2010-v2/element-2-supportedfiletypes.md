---
description: Defines the file types that the app can share (Windows 8.1, child of FileOpenPicker).
Search.Product: eADQiWindows 10XVcnh
title: 'SupportedFileTypes (Windows 8.1 extensions schema, child of FileOpenPicker)'
...
# SupportedFileTypes (extensions schema for Windows 8.1, child of FileOpenPicker)
