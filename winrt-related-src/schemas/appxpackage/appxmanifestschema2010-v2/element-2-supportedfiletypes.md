...
MS-HAID: AppxManifestSchema2010\_v2.element\_2\_SupportedFileTypes
MSHAttr:
...
<tbody>
<tr class="odd">
<td>[FileType (type: ST_FileType)](element-2-filetype.md)</td>
...
<tr class="even">
<td>[SupportsAnyFileType](element-1-supportsanyfiletype.md)</td>
