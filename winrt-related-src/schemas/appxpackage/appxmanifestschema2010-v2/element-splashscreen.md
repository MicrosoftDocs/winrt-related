---
description: Defines the appearance of the splash screen, which is displayed by the app during launch (extensions schema for Windows 8.1).
Search.Product: eADQiWindows 10XVcnh
title: SplashScreen (Windows 8.1 extensions schema)
...
# SplashScreen (extensions schema for Windows 8.1)
