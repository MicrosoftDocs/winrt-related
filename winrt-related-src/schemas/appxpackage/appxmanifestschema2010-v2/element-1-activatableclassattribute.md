---
description: Defines an attribute of the class that is stored in the Windows Runtime property store (Windows 8.1 extensions, descendant of OutOfProcessServer).
Search.Product: eADQiWindows 10XVcnh
title: ActivatableClassAttribute (Windows 8.1 extensions, descendant of OutOfProcessServer)
...
# ActivatableClassAttribute (Windows 8.1 extensions, descendant of OutOfProcessServer)
