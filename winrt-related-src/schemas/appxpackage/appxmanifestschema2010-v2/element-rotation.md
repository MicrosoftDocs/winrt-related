---
description: Specifies a single rotational orientation in which an app will display (extensions schema for Windows 8.1).
Search.Product: eADQiWindows 10XVcnh
title: Rotation (Windows 8.1 extensions schema)
...
# Rotation (extensions schema for Windows 8.1)
