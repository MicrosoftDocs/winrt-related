---
description: A supported file type specified as its file type extension (Windows 8, descendant of FileTypeAssociation).
Search.Product: eADQiWindows 10XVcnh
title: 'FileType (Windows 8 package schema, descendant of FileTypeAssociation)'
