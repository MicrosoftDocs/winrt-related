---
description: Defines a globally unique identifier for a package (Windows 8).
Search.Product: eADQiWindows 10XVcnh
title: Identity (Windows 8 package schema)
...
<p>Use the <a href="element-displayname.md">DisplayName</a> attribute to display a package name to users.</p></td>
