---
description: Declares a runtime class associated with the extensibility point (Windows 8).
Search.Product: eADQiWindows 10XVcnh
title: 'ActivatableClass (Windows 8 package schema, child of InProcessServer)'
