---
description: Declares a package extensibility point of type windows.activatableClass.inProcessServer (Windows 8).
Search.Product: eADQiWindows 10XVcnh
title: InProcessServer (Windows 8 package schema)
...
# InProcessServer (package schema for Windows 8)
