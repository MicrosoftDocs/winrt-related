...
<p>In your app, to find out the content spoken in the subset of a <strong>ListenFor</strong> element represented by a <strong>PhraseTopic</strong> reference, you can access the <a href="https://msdn.microsoft.com/library/windows/apps/windows.media.speechrecognition.speechrecognitionsemanticinterpretation.properties"><strong>SpeechRecognitionSemanticInterpretation.Properties</strong></a> dictionary using a key with the same value as the <strong>Label</strong> of the <strong>PhraseTopic</strong>.</p>
</td>
</tr>
</table>
