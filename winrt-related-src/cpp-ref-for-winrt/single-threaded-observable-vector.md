...
This is how you'd create an instance of the type defined above. Instead of calling the **winrt::single_threaded_observable_vector** factory function template, you create the collection object by calling [**winrt::make**](./make.md).
