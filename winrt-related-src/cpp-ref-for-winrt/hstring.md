...
A sequential collection of UTF-16 Unicode characters representing a text string. For more examples and info about **winrt::hstring**, see [Strings](/windows/uwp/cpp-and-winrt-apis/strings?branch=live). The **winrt::hstring** type encapsulates [HSTRING](https://msdn.microsoft.com/library/windows/desktop/br205775) behind an interface similar to that of `std::wstring`.
