...
| Feature                                   | Alternative                                                           |
|-------------------------------------------|-----------------------------------------------------------------------|
| Console | [Create a UWP Console App](https://docs.microsoft.com/en-us/windows/uwp/launch-resume/console-uwp) |
| Current directory | none |
| Fibers | none |
| Memory manager | Heap API | 
| Named pipes | [Interprocess Communications](https://docs.microsoft.com/en-us/windows/win32/ipc/interprocess-communications) |
...
DDE/NetDDE | none |
DWM | [Windows.UI.Composition](https://docs.microsoft.com/en-us/uwp/api/windows.ui.composition)] |
...
User: MDI | [TabView XAML Control](https://docs.microsoft.com/en-us/windows/communitytoolkit/controls/tabview), [AppWindow](https://docs.microsoft.com/en-us/uwp/api/windows.ui.windowmanagement.appwindow) |
