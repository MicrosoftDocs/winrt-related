...
MIDL 3.0 is a much simpler and more modern syntax, whose purpose is to declare Windows Runtime APIs. And you can use it in your projects, particularly to declare [C++/WinRT](/windows/uwp/cpp-and-winrt-apis/index) runtime classes. The first-party Windows Runtime APIs are declared in MIDL 3.0 form in `%WindowsSdkDir%Include<WindowsTargetPlatformVersion>\cppwinrt\winrt`.
